...
//                     spreadRadius: 1,
//                     blurRadius: 20,
//                     offset: Offset(0, 10), // X, Y position
//                   ),
//                 ],
//               ),
...
//                       child: Text("Spicy",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 25),) ,
//                     ),
//                     Slider(
//                         value: (nihad),
//                         onChanged: (value){
...
//                     Row(
//                       children: [
//                         Text("Hot",style: TextStyle(fontSize: 25,color: Colors.green),),
//                         SizedBox(width: 80,),
//                         Text("Mid",style: TextStyle(fontSize: 25,color: Colors.green),)
//                       ],
//                     )
//                   ],
//                 ),
...
//
//                   children: [
//                     Text("Portion",style: TextStyle(fontSize: 25),),
//                     Row(
...
//                           padding: const EdgeInsets.all(20),
//                           child: Center(
//                             child: Text("$Count",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 25),),
//                           ),
//                         ),
//                         Container(
//                           decoration: BoxDecoration(
